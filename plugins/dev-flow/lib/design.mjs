// 讀 .design/ 成一棵樹:system(願景、全域 Law 三區——領域不變量、架構的層、契約的對外 I/O——、語言與工具、Features)、requirements(需求:驗收、優先、里程碑、調整)、modules、features、abstracts、gaps、journals。只讀不判;判在 commands/。
