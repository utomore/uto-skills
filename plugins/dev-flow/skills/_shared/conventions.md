...
- 編號四位數遞增(`func-0001`、`bug-0001`、`enhance-0001`、`adr-0001`):建立新檔前先掃描該資料夾現有檔名,取最大編號 +1
...
```yaml
---
id: func-0003            # func-XXXX | bug-XXXX | enhance-XXXX | adr-XXXX | report-<date>-<slug>
...
- **所有類型都要寫**:architecture / adr / spec / **bug** / **enhance** / report,一個都不能少
