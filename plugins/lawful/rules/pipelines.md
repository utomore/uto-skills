...
| 目標 | `objectives.md` 的 `## O-n:<一句話>` | 一個能力承諾,由開發者答三問:**What** 做到什麼(一句話:使用者做得到什麼、或世界變成什麼樣)、**How** 怎麼看得出做到了(一句**可觀察的判準**)、**Which** 落在哪一級**優先**(1 到 4,1 最高)、由哪幾條 pipeline 撐(里程碑)。至少一個,可以多個 |
