---
name: project
description: lawful(有 .lawful/ 的 Haskell 專案)的立案:與開發者訪談出 Cone.md 的願景、需求與驗收、全域 Law(領域不變量、四層、對外 I/O)、專案約束,以及目標檔與模組單元表;切片開工之前唯一先寫的東西。觸發詞:立案、開新專案、願景、需求、系統設計、主架構、建 .lawful、Cone.md、技術選型。Use when starting a pure-functional project or reshaping its vision, requirements and boundaries.
user-invocable: true
